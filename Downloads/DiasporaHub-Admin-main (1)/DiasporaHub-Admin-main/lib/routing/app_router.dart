...
import 'package:diasorahub_admin/pages/upload_pharmacies.dart';
import 'package:diasorahub_admin/pages/view_pharmacies.dart';
...
final GoRouter appRouter = GoRouter(
  ...
  routes: [
    ...
    GoRoute(
      path: '/upload_pharmacies',
      name: 'upload_pharmacies',
      builder: (context, state) => const UploadPharmacies(),
    ),
    GoRoute(
      path: '/view_pharmacies',
      name: 'view_pharmacies',
      builder: (context, state) => const ViewPharmacies(),
    ),
  ],
);
